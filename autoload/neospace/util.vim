...
"    Basic tools
"""""""""""""""""""""""""""""""""""""""""""""""""""
function neospace#util#err(msg)
  echohl ErrorMsg
  echom '[neospace] '.a:msg
  echohl None
endfunction

function neospace#util#warn(msg)
  echohl WarningMsg
  echom '[neospace] '.a:msg
  echohl None
endfunction

function neospace#util#info(msg)
  echom '[neospace] '.a:msg
endfunction

" argument plugin is the vim plugin's name
function neospace#util#IsDir(plugin) abort
...
"    Utilities
"""""""""""""""""""""""""""""""""""""""""""""""""""
function neospace#util#ToggleCursorColumn()
  if &cursorcolumn
...
function neospace#util#ToggleColorColumn()
  if &colorcolumn
...
function neospace#util#Runtimepath()
...
function neospace#util#OpenPluginHomepage() abort
  let line = getline(".")
  let $BROWSER = 'open'
...
function neospace#util#RootDirectory()
