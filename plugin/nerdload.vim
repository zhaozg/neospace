" nerdtree ignore files or fold in .gitignore
" https://gist.github.com/scrooloose/0cdccd1171891caf0e24

if exists("loaded_nerdtree_gitignore_filter") || !exists('*NERDTreeAddPathFilter')
  finish
endif
